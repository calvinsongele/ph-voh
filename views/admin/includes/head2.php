<!--Header Nav-->
		<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <div class="container-fluid">
				<a class="navbar-brand text-md-center" href="/"><?php echo $this->_company['c_name'] ?></a>
				...
				<ul class="navbar-nav ml-auto ml-md-0">
					<li class="nav-item dropdown animate-dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
							<!--<a class="dropdown-item" href="/dashboard/profile"><i class="fa fa-user"></i> Profile Overview</a>-->
							<!--<a class="dropdown-item" href="/dashboard/profile-settings"><i class="fa fa-pencil"></i> Profile Settings</a>-->
							<!--<a class="dropdown-item" href="/dashboard/changepassword"><i class="fa fa-exchange"></i></i> Change Password</a>-->
														<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="/dashboard/logout"><i class="fa fa-sign-out"></i> Logout</a>
							<a class="dropdown-item" href="/dashboard/logout?all_devices=true"><i class="fa fa-sign-out"></i> Logout all devices</a>
						</div>
					</li>
				</ul>
